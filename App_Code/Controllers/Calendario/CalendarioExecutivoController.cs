...
/// <summary>
/// Descrição resumida de CalendarioExecutivoController
/// </summary>
namespace Controllers.Calendario
{
    public class CalendarioExecutivoController : Controller
    {
        public CalendarioExecutivoController()
        {
            //
        ...
        private string JsonAtividadesUsuarioMes(int mes, int ano, int usuario)
        {
            ...
            query.CommandText.AppendLine(" AND D.K_EXECUTIVOCONTAS = 'S'");
