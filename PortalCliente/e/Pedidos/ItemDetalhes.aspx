<%@ Page Title="Detalhes item" Language="C#" AutoEventWireup="true"
    Inherits="PortalCliente.Pedidos.ItemDetalhesPage, Benner.Corporativo.Wes.WebApp" %>
...
<script runat="server">
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        ITEM_TITLE.Title = "INFORMAÇÕES";
        ITEM_TITLE.Description = " do produto para compra";
            ...
            <div class="portlet-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <erp:ErpTabControl runat="server" ID="tabs" ShowBorder="true" RenderAsPortlet="false">
                            <erp:ErpTab runat="server" ID="tab_1_1" Text="Produto">
                                <div class="row">
                                    ...
                                    <wes:AjaxForm runat="server"
                                        ...
                                        EntityViewName="PORTAL_CLI_DETALHESPRODUTO.FORM"
                                        ...
                                        ChromeState="Normal"
                                        PageWidgetHandle="1"
                                        Title="Produto >> detalhes do produto"
                                        ShowTitle="True" />
                            ...
                            <erp:ErpTab runat="server" ID="tab_1_2" Text="Aplicações">
                                <div class="row">
                                    ...
                                    <wes:SimpleGrid runat="server"
                                        ID="GridAplicacoes"
                                        SystemInstanceName="CORPORATIVO"
                                        EntityViewName="PORTAL_CLI_DETALHEAPLICACOES.GRID"
                            ...
                            <erp:ErpTab runat="server" ID="tab_1_3" Text="Substitutos">
                                <div class="row">
                                    ...
                                    <wes:SimpleGrid runat="server"
                                        ID="GridSubstitutos"
                                        SystemInstanceName="CORPORATIVO"
                                        EntityViewName="PORTAL_CLI_DETALHESUBSTITUTOS.GRID"
