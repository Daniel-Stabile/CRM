<%@ Page Title="Detalhes do pedido" Language="C#" AutoEventWireup="true"
    Inherits="PortalCliente.Pedidos.CadastrarItemPage, Benner.Corporativo.Wes.WebApp" %>
                            ...
                            <erp:ErpTab runat="server" ID="ErpTab1" Text="Condições gerais">
                                <div class="row">
                                    <wes:CommandsPanel
                                        ...
                                        EntityViewName="PORTAL_CLI_PEDIDOCONDICOESGERAIS.FORM"
                                        UserDefinedCommandsVisible="true"
                                        SystemInstanceName="CORPORATIVO" />
                                </div>
                            ...
                            <erp:ErpTab runat="server" ID="ErpTab2" Text="Local de entrega">
                                <div class="row">
                                    <wes:CommandsPanel
                                        ...
                                        EntityViewName="PORTAL_CLI_PEDIDOLOCALENTREGA.FORM"
                                        UserDefinedCommandsVisible="true"
                                        SystemInstanceName="CORPORATIVO" />
                                </div>
                            ...
                            <erp:ErpTab runat="server" ID="ErpTab3" Text="Documentos">
                                <div class="row">
                                     <wes:SimpleGrid runat="server"
                                         ID="GridDocumentos"
                                         SystemInstanceName="CORPORATIVO"
                                         EntityViewName="PORTAL_CLI_PEDIDODOCUMENTOS.GRID"
                                         ...
                                         ChromeState="Normal"
                                         PageWidgetHandle="1"
                                         FormUrl="~/PortalCliente/e/Pedidos/DocumentoEdit.aspx" />
                                </div>
                            </erp:ErpTab>
                        </erp:ErpTabControl>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            ...
                            <wes:SimpleGrid runat="server"
                                ID="GridItens"
                                SystemInstanceName="CORPORATIVO"
                                EntityViewName="PORTAL_CLI_PEDIDOITENS.GRID"
                                ...
                                FormUrl="~/PortalCliente/e/Pedidos/CadastrarItemEntrega.aspx" />                            
                        </div>
