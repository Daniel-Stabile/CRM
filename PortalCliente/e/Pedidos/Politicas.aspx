<%@ Page Title="Politicas" Language="C#" AutoEventWireup="true"
    Inherits="PortalCliente.Pedidos.PoliticasPage, Benner.Corporativo.Wes.WebApp" %>
...
<asp:Content runat="server" ID="Content" ContentPlaceHolderID="Main">
    ...
    <div class="row">         
        <wes:SimpleGrid runat="server"
            ...
            EntityViewName="PORTAL_CLI_POLITICAS.GRID"
    ...
    <div class="row"> 
        ...
        <wes:SimpleGrid runat="server"
            ID="GridRegras"
            SystemInstanceName="CORPORATIVO"
            EntityViewName="PORTAL_CLI_POLITICAREGRAS.GRID"
