    ...
    <div class="col-md-4">
        <div class="row">
            <wes:AjaxForm
                ...
                BootstrapCols="12"
                ShowTitle="True"
                EntityViewName="FN_DOCUMENTOS.PORTALCLIENTE.CONSULTAFINANCEIRA.FORM"
                ChromeState="Fixed"
                CanDelete="False"
                CanUpdate="False"
                CanInsert="False"
                ...
                <div class="tab-pane fade" id="tabIMPOSTOSRETIDOS">
                    <div class="row">
                        <wes:SimpleGrid runat="server"
                            ...
                            EntityViewName="PORTAL_CLI_FINANCEIRO_RETENCOES.GRID"
                ...
                <div class="tab-pane fade" id="tabITENS">
                    <div class="row">
                        <wes:SimpleGrid runat="server"
                            ...
                            BootstrapCols="12"
                            ShowTitle="False"
                            EntityViewName="CM_ITENS.PORT_CLIENTE.CONSULTAFINANCEIRA.GRID"
                            ChromeState="Fixed"
                            CanDelete="False"
                            CanUpdate="False"
                            CanInsert="False"
