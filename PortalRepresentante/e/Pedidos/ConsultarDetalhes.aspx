<%@ Page Title="Detalhes do pedido" Language="C#" AutoEventWireup="true"
    Inherits="PortalRepresentante.Pedidos.ConsultarDetalhesPage, Benner.Corporativo.Wes.WebApp" %>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="row">
                            <wes:SimpleGrid runat="server"
                                ...
                                EntityViewName="PORTAL_REP_CONDICOES.GRID"
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            <wes:SimpleGrid runat="server"
                                ID="PedidoItens"
                                SystemInstanceName="CORPORATIVO"
                                EntityViewName="PORTAL_REP_PEDIDOITEM.GRID"
                                Title="Itens >>"
                                UserDefinedCriteriaWhereClause="A.ORDEMVENDA = @CAMPO(HANDLE)"
                                UserDefinedSelectColumnVisible="False"
                                HideDeveloperCommands="False"
                                ...
                                ChromeState="Normal"
                                PageWidgetHandle="2"
                                FormUrl="~/PortalRepresentante/e/Pedidos/ConsultarDetalhesItem.aspx" />
                        </div>
                    </div>
                </div>
            </div>
