<%@ Page Title="Detalhes do item" Language="C#" AutoEventWireup="true"
    Inherits="PortalRepresentante.Pedidos.CadastrarItemEntregaPage, Benner.Corporativo.Wes.WebApp" %>
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <erp:SimpleCardView
                                        ...
                                        EntityViewName="PORTAL_REP_PEDIDOITEM.FORM"
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            <wes:SimpleGrid runat="server"
                                ...
                                EntityViewName="PORTAL_REP_PEDIDOITEMENTREGAS.GRID"
