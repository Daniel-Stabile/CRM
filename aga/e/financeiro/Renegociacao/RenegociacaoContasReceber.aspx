<%@ Page Title="Renegociar contas a receber" Language="C#" Inherits="Benner.Corporativo.Wes.WebApp.aga.e.Financeiro.Renegociacao.RenegociacaoDocumentoPage" %>
    ...
    <script type="text/javascript">
        ...
        setCreLabelOnStep1 = function () {
            ...
            if (!intent) {
                bootbox.alert({
                    title: 'Atenção!',
                    message: "Para a seleção de parcelas funcionar corretamente, você deve chegar nesta página através do menu. <br><br>Em nosso menu selecione Contas a receber -> Renegociar."
                });
            }
        }
