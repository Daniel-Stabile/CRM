...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:AjaxForm runat="server" ID="FORMULARIO" Title="Impostos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="AGA_TR_IMPOSTOS.FORM" FormMode="ReadOnly" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="'forcar_carga_form'='forcar_carga_form'" UserDefinedCommandsVisible="True" PageWidgetHandle="38775" Level="20" Order="1"  />
        <div class="col-md-12">
            <div class="portlet body">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-3">
                        <ul class="nav nav-tabs tabs-left">
							<li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_7566" class="active"><a data-toggle="tab" href="#tabWIDGET_7566">Alíquotas por classificações de origem</a></li>
							...
							<li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_2435"><a data-toggle="tab" href="#tabWIDGET_2435">Alíquotas por tipo de pessoa / Vigência</a></li>                                                                       
                            ...
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_311_8059"><a data-toggle="tab" href="#tabWIDGET_311_8059">Configurações apuração DIFAL/FCP&gt;Financeiro</a></li>
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_311_6018"><a data-toggle="tab" href="#tabWIDGET_311_6018">Configurações apuração ST&gt;Configurações apuração ST - Campos</a></li>
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_311_6019"><a data-toggle="tab" href="#tabWIDGET_311_6019">Configurações apuração ST&gt;Configurações apuração ST - Estados</a></li>
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_311_6020"><a data-toggle="tab" href="#tabWIDGET_311_6020">Configurações apuração ST&gt;Configurações apuração ST - Vencimentos</a></li>
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="CONFIGURAESAPURAOPRESUMIDOSC"><a data-toggle="tab" href="#tabCONFIGURAESAPURAOPRESUMIDOSC">Configurações apuração presumido SC</a></li>
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_6634"><a data-toggle="tab" href="#tabWIDGET_6634">Configurações de cód. receita</a></li>
                            ...
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="DIFALNOCONTRIBUINTE"><a data-toggle="tab" href="#tabDIFALNOCONTRIBUINTE"><%= Benner.Tecnologia.Wes.Components.LanguageTranslator.Translate(@"DIFAL - Não Contribuinte")%></a></li>
                            ...
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="DIFERIMENTOICMS"><a data-toggle="tab" href="#tabDIFERIMENTOICMS">Diferimento ICMS - Faturamento</a></li>
                            ...
                            <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_6797"><a data-toggle="tab" href="#tabWIDGET_6797">Parâmetros apuração contr. prev.</a></li>
