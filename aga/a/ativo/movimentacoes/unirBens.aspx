<%@ Page Title="Unir Bens" Language="C#" Inherits="Benner.Corporativo.Wes.WebApp.aga.a.Ativo.Movimentacoes.UnirBensPage" %>
    ...
    <div class="form-wizard">
      <div class="form-body">
        <ul class="nav nav-pills nav-justified steps">
          ...
          <li><a data-toggle="tab" class="step" href="#tab3"><span class="number">3</span><span class="desc"><i class="fa-duotone fa-check fa-fw"></i>Unir bens</span></a></li>
        </ul>
