<%@ Page Title="REG.C860: EQUIPAMENTO SAT - CF-E (59) - Gerados" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
...
) AND (A.DOCUMENTO = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4003_at8200_hs9fddfde.aspx" UserDefinedDisableRowSelection="False" PageId="ED_CARGA_EFDPC_SAIDAS_REGISTROC860__ED_CARGA_EFDPC_SAIDAS_REGISTROC860GR_FORM" Level="20" Order="10"  />
