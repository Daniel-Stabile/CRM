<%@ Page Title="Tabelas auxiliares - Famílias de item" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
    <wes:AjaxForm runat="server" ID="FORMULARIO" Title="Tabelas auxiliares - Famílias de item" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_PD_FAMILIASPRODUTOS.FORM" CanDelete="True" CanUpdate="True" CanInsert="True" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="'forcar_carga_form'='forcar_carga_form'" UserDefinedCommandsVisible="True" PageId="MF_CONFIGURACOES__FAMILIAS_DE_ITEM_FORM" Level="20" Order="1"  />
    ...
    <div class="tabbable-line">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tabWIDGET_1346">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_1346" Title="Clientes" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Fixed" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="AGA_GN_PESSOAS.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.EHCLIENTE = 'S'" FormUrl="~/aga/a/f/aga_t717_at1346_hs3e0e3a67.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="MF_CONFIGURACOES__FAMILIAS_DE_ITEM_FORM" Level="20" Order="10"  /></div>
        </div>
    ...
    <wes:SimpleGrid runat="server" ID="WIDGET_6739" Title="Políticas comerciais" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_GN_POLITICASCOMERCIAIS.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.FAMILIA = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4453_at6739_hs47c2a186.aspx" UserDefinedDisableRowSelection="False" PageId="MF_CONFIGURACOES__FAMILIAS_DE_ITEM_FORM" Level="20" Order="25"  /></div>
        ...
        <div class="tab-pane" id="tabWIDGET_7522">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_7522" Title="Tipos de documento habilitação" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="AGA_GN_DOCUMENTOHABILITACAOITEM.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.FAMILIA = @RASTRO(PD_FAMILIASPRODUTOS) AND (A.FAMILIA = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t5169_at7522_hsa7d91583.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="MF_CONFIGURACOES__FAMILIAS_DE_ITEM_FORM" Level="20" Order="30"  /></div>
        </div>
