<%@ Page Title="Requisição de cadastro de itens" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
    ...
    <div class="tabbable-line">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tabWIDGET_1836">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_1836" Title="Na filial" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Fixed" CanDelete="True" CanUpdate="True" CanInsert="False" EntityViewName="AGA_PD_PRODUTOS.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t807_at1836_hsd655c67e.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="50"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_3567">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_3567" Title="Imagens" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="AGA_GN_IMAGENS.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.TABELAORIGEM IN (SELECT B.HANDLE FROM Z_TABELAS B WHERE B.NOME = 'PD_PRODUTOSPAI') AND A.HANDLEORIGEM = @TABELA(PD_PRODUTOSPAI))" FormUrl="~/aga/a/f/aga_t2464_at3567_hs56fbf359.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="60"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_6725">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_6725" Title="Aplicações" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOPAIAPLICACOES.GRID" CanDelete="True" CanUpdate="False" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4446_at6725_hs141bfe70.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="70"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_6410">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_6410" Title="Produtos sinônimos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOSINONIMOS.GRID" CanDelete="True" CanUpdate="True" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4154_at6410_hs7a58bb09.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="80"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_3905">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_3905" Title="Reduções INSS" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOPAIREDUCOES.GRID" CanDelete="True" CanUpdate="True" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t2600_at3905_hsd9090896.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="90"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_6756">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_6756" Title="Alternativos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOALTERNATIVOPRODUTOS.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4468_at6756_hs1d842fab.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="100"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_6746">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_6746" Title="Substitutos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOPAISUBSTITUTOS.GRID" CanDelete="True" CanUpdate="False" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAIORIGEM = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t4458_at6746_hs5ad9b8f9.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_PRODUTOS_EM_CADASTRO__EMCADASTRADO_FORM" Level="20" Order="110"  /></div>
        </div>
      </div>
    </div>
  </div>
