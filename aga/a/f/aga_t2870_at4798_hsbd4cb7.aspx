...
WHERE A.ITEMNF = B.HANDLE 
     ...
     AND C.HANDLE = @RASTRO(PR_ORDEMINDUSTRIALIZADOITENS)) AND (A.ORDEMINDUSTRIALIZADOITEM = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t3035_at6182_hsd84b856d.aspx" UserDefinedDisableRowSelection="False" PageId="CARGA_DE_OC_INDUSTRIALIZADO__ITENS_FORM" Level="20" Order="20"  />
        </div>
