<%@ Page Title="Parâmetros" Language="C#" Inherits="aga.a.administracao.ParametrosPage,Benner.Corporativo.Wes.WebApp" %>
  ...
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
      <ul class="nav nav-tabs tabs-left">
        ...
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="PARMETROSDOMDULOORAMENTO"><a data-toggle="tab" href="#tabPARMETROSDOMDULOORAMENTO">Parâmetros do módulo orçamento</a></li>
        ...
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_2962"><a data-toggle="tab" href="#tabWIDGET_2962">Parâmetros do módulo orçamento</a></li>
        ...
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_1100"><a data-toggle="tab" href="#tabWIDGET_1100">Traduções</a></li>
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="ALADASEMPENHO"><a data-toggle="tab" href="#tabALADASEMPENHO">Alçadas empenho</a></li>
      </ul>
    </div>
    ...
    <wes:AjaxForm runat="server" ID="WIDGET_3458" Title="Parâmetros do módulo materiais" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="False" CanUpdate="True" CanInsert="True" EntityViewName="AGA_PD_PARAMETROSESTOQUEEMPRESA.FORM" FormMode="View" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="(A.EMPRESA = @CAMPO(HANDLE))" UserDefinedCommandsVisible="True" PageId="ADM__PARAMETROS_FORM" Level="20" Order="145"  /></div>
        ...
        <div class="tab-pane" id="tabPARMETROSDOMDULOORAMENTO">
                    <div class="row">
    <wes:AjaxForm runat="server" ID="PARMETROSDOMDULOORAMENTO" Title="Parâmetros do módulo orçamento" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="FN_PARAMETROS.ORCAMENTO.FORM" FormMode="None" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="(A.EMPRESA = @CAMPO(HANDLE))" UserDefinedCommandsVisible="True" PageId="ADM__PARAMETROS_FORM" Level="20" Order="146"  /></div>
        </div>
    ...
    <wes:SimpleGrid runat="server" ID="WIDGET_4834" Title="Sócios" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_GN_PESSOASOCIOS.GRID" CanDelete="True" CanUpdate="True" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.EMPRESA = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t901_at4834_hsca7de334.aspx" UserDefinedDisableRowSelection="False" PageId="ADM__PARAMETROS_FORM" Level="20" Order="195"  /></div>
        ...
        <div class="tab-pane" id="tabWIDGET_1100">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_1100" Title="Traduções" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_Z_EMPRESATRADUCOES.GRID" CanDelete="True" CanUpdate="True" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.EMPRESA = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t1377_at1100_hs95210505.aspx" UserDefinedDisableRowSelection="False" PageId="ADM__PARAMETROS_FORM" Level="20" Order="200"  /></div>
        </div>
        <div class="tab-pane" id="tabALADASEMPENHO">
                    <div class="row">
    <wes:EditableGrid runat="server" ID="ALADASEMPENHO" Title="Alçadas empenho" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="CT_EMPENHOSALCADAS.ORCAMENTO.GRID" Mode="None" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="OnlyCompany" UserDefinedCriteriaWhereClause="A.LIGACAOPARAMETROS = @CAMPO(HANDLE)" ShowExport="True" PageId="ADM__PARAMETROS_FORM" Level="20" Order="210"  /></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <script type="text/javascript">
            $('li[data-widget-id="WIDGET_2962"]').hide()
$('li[data-widget-id="WIDGET_1100"]').hide()
