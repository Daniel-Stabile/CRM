...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
    <wes:AjaxForm runat="server" ID="FORMULARIO" Title="Produtos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_PD_PRODUTOSPAI.FORM" CanDelete="False" CanUpdate="False" CanInsert="False" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="'forcar_carga_form'='forcar_carga_form'" UserDefinedCommandsVisible="True" PageId="PD_PRODUTOSPRINCIPIOATIVO__PD_PRODUTOSPAI_FORM" Level="20" Order="1"  />
    ...
    <wes:SimpleGrid runat="server" ID="WIDGET_3567" Title="Imagens" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_GN_IMAGENS.GRID" CanDelete="True" CanUpdate="True" CanInsert="True" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.TABELAORIGEM IN (SELECT B.HANDLE FROM Z_TABELAS B WHERE B.NOME = 'PD_PRODUTOSPAI') AND A.HANDLEORIGEM = @RASTRO(PD_PRODUTOSPAI))" FormUrl="~/aga/a/f/aga_t2464_at3567_hs56fbf359.aspx" UserDefinedDisableRowSelection="False" PageId="PD_PRODUTOSPRINCIPIOATIVO__PD_PRODUTOSPAI_FORM" Level="20" Order="20"  /></div>
        ...
        <div class="tab-pane" id="tabWIDGET_1836">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_1836" Title="Na filial" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_PD_PRODUTOS.GRID" CanDelete="True" CanUpdate="True" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.PRODUTOPAI = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t807_at1836_hsd655c67e.aspx" UserDefinedDisableRowSelection="False" PageId="PD_PRODUTOSPRINCIPIOATIVO__PD_PRODUTOSPAI_FORM" Level="20" Order="25"  /></div>
        </div>
