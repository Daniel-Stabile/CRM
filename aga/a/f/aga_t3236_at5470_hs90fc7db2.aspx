<%@ Page Title="I200 - Lançamentos Contábeis - Normais" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        ...
        <wes:SimpleGrid runat="server" ID="WIDGET_5469" Title="I250 - Partidas do Lançamento" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Normal" EntityViewName="AGA_ED_LANCAMENTOPARTIDAS.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.HANDLE IN (SELECT PARTIDALANCAMENTO.HANDLE
              ...
              WHERE PERIODO.HANDLE = @RASTRO(ED_PERIODOS)) AND (A.LANCAMENTO = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t3237_at5469_hs49d66b09.aspx" UserDefinedDisableRowSelection="False" PageId="ED_CARGA_LANCAMENTOS_CONTABEIS__NORMAIS_FORM" Level="20" Order="10"  />
        </div>
