...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
    <wes:AjaxForm runat="server" ID="FORMULARIO" Title="Apontamentos/medições" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="AGA_CN_APONTAMENTOS.FORM" FormMode="View" IncludeRecordInRecentItems="True" UserDefinedCriteriaWhereClause="'forcar_carga_form'='forcar_carga_form'" UserDefinedCommandsVisible="True" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="1"  />
      <div class="col-md-12"><div class="portlet light">
    <div class="tabbable-line">
      <ul class="nav nav-tabs">
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_2829" class="active"><a data-toggle="tab" href="#tabWIDGET_2829"><%= Benner.Tecnologia.Wes.Components.LanguageTranslator.Translate(@"Itens/objetos")%></a></li>
        ...
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="WIDGET_4398"><a data-toggle="tab" href="#tabWIDGET_4398"><%= Benner.Tecnologia.Wes.Components.LanguageTranslator.Translate(@"Documentos financeiros")%></a></li>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tabWIDGET_2829">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_2829" Title="Itens/objetos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Fixed" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="AGA_CN_APONTAMENTOOBJETOS.GRID" Mode="Search" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.APONTAMENTO  = @CAMPO(HANDLE)" FormUrl="~/aga/a/f/aga_t2226_at2829_hsf7c83b3b.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="10"  /></div>
        </div>
    ...
    <wes:SimpleGrid runat="server" ID="WIDGET_2887" Title="Histórico" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="AGA_PD_STATUS.GRID" Mode="Search" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.HANDLETABELAORIGEM IN (SELECT B.HANDLE FROM Z_TABELAS B WHERE B.NOME = 'CN_APONTAMENTOS') AND A.HANDLEREGISTROORIGEM = @RASTRO(CN_APONTAMENTOS))" FormUrl="~/aga/a/f/aga_t1951_at2887_hs8890ce6d.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="15"  /></div>
        ...
        <div class="tab-pane" id="tabWIDGET_3747">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_3747" Title="Recebimentos físicos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="AGA_CP_RECEBIMENTOFISICO.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.APONTAMENTO = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t1584_at3747_hsa29a25b.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="20"  /></div>
        </div>
        <div class="tab-pane" id="tabWIDGET_3908">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_3908" Title="Municípios" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="AGA_CN_APONTAMENTOMUNICIPIOS.GRID" Mode="Search" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.APONTAMENTO = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t2601_at3908_hsef5f450.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="25"  /></div>
        </div>
...
APONTAMENTO = @RASTRO(CN_APONTAMENTOS)))" FormUrl="~/aga/a/f/aga_t1216_at3798_hs3a560b6b.aspx" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="35"  /></div>
        </div>
    ...
    <wes:SimpleGrid runat="server" ID="WIDGET_3292" Title="Ordens de compra geradas" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" EntityViewName="AGA_CP_ORDENSCOMPRA.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.APONTAMENTOGERADOR = @CAMPO(HANDLE))" FormUrl="~/aga/a/f/aga_t1529_at3292_hsd27bd2ef.aspx" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="40"  /></div>
        ...
        <div class="tab-pane" id="tabWIDGET_4398">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="WIDGET_4398" Title="Documentos financeiros" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="AGA_FN_DOCUMENTOS.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.HANDLE IN ( SELECT DOCUMENTOCONVENIO FROM  CN_APONTAMENTOOBJETOS  
 WHERE APONTAMENTO = @RASTRO(CN_APONTAMENTOS) )" FormUrl="~/aga/a/f/aga_t1216_at4398_hs14965b89.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="45"  /></div>
        </div>
        <div class="tab-pane" id="tabANEXOS">
                    <div class="row">
    <wes:SimpleGrid runat="server" ID="ANEXOS" Title="Anexos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="FORMULARIO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="CN_CONTRATOS.APONTAMENTOANEXOS.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="OnlyCompany" UserDefinedCriteriaWhereClause="A.APONTAMENTO = @CAMPO(HANDLE)" FormUrl="~/aga/a/contratos/apontamentos/anexoApontamento.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="CN_APONTAMENTOS__CONFIRMADOS_FORM" Level="20" Order="55"  /></div>
        </div>
