<%@ Page Title="Impostos - Impostos federais" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
  ...
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
      <ul class="nav nav-tabs tabs-left">
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="FORMULARIO" class="active"><a data-toggle="tab" href="#tabFORMULARIO">Imposto federal</a></li>
