<%@ Page Title="Requisição" Language="C#" Inherits="Benner.Corporativo.Wes.WebApp.aga.a.Aquisicoes.MinhasRequisicoes" %>
  ...
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
      <ul class="nav nav-tabs tabs-left">
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="FORMULARIO" class="active"><a data-toggle="tab" href="#tabFORMULARIO">Requisição</a></li>
