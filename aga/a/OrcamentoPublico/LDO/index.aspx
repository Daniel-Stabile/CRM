<%@ Page Title="LDO" Language="C#" Inherits="Benner.Corporativo.Wes.WebApp.aga.a.orcamento.PlanejamentoPage" %>
  ...
  <div class="row">
    <div class="col-md-3 col-sm-3 col-xs-3">
      <ul class="nav nav-tabs tabs-left">
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="PLANEJAMENTO" class="active"><a data-toggle="tab" href="#tabPLANEJAMENTO">LDO</a></li>
        ...
        <li onclick="Benner.Page.changeSelectedTab(this)" data-widget-id="PROJETOSESTRATGICOS"><a data-toggle="tab" href="#tabPROJETOSESTRATGICOS">Projetos Estratégicos</a></li>
