...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
    <wes:AjaxForm runat="server" ID="FORMOP_ACOESPROJETOS" Title="Ação de Operação Especial" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="OP_ACOESPROJETOSOPERACAOESPECIAL.CUSTOM.FORM" FormMode="None" IncludeRecordInRecentItems="True" UserDefinedCommandsVisible="True" PageId="PAGES_ORCAMENTOPUBLICO_ACOESOPERACAO_FORM" Level="20" Order="100"  />
    <wes:SimpleGrid runat="server" ID="CLASSIFICAOORAMENTRIADAAO" Title="Classificação orçamentária da ação" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="FORMOP_ACOESPROJETOS" ChromeState="Normal" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="OP_CLASSIFICACAOORCAMENTARIA.CUSTOM.GRID" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.OPERACAOESPECIAL = @CAMPO(OPERACAOESPECIAL) AND A.ACOESPROJETOS = @CAMPO(HANDLE)" FormUrl="~/aga/a/OrcamentoPublico/ClassificacaoOrcamentariaOperacao/Form.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="PAGES_ORCAMENTOPUBLICO_ACOESOPERACAO_FORM" Level="20" Order="105"  /><div class="col-md-12"><div class="portlet light">
...
AND A.ORIGEM IN ('B','C','D','E','Q','1','5','6')" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="PAGES_ORCAMENTOPUBLICO_ACOESOPERACAO_FORM" Level="20" Order="140"  /></div>
        </div>
...
LEFT JOIN FN_LANCAMENTOCC LCC ON LCC.LANCAMENTO = L.HANDLE
WHERE   A.ABRANGENCIA = 'N'  AND  (L.ACOESPROJETOS = @CAMPO(ACOESPROJETOS) OR LCC.ACOESPROJETOS = @CAMPO(ACOESPROJETOS) ) )" FormUrl="~/aga/e/financeiro/zoomdedocumentos/Form.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="PAGES_ORCAMENTOPUBLICO_ACOESOPERACAO_FORM" Level="20" Order="160"  /></div>
        </div>
