<%@ Page Title="10.06 - PIS/COFINS Serviços - Terceiros" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
...
SELECT IMPOSTO.HANDLE
 ...
 WHERE ITEM.HANDLE = IMPOSTO.ITEM
   ...
   AND NOTA.TIPONOTA = 'N'
)" FormUrl="~/aga/a/f/aga_t3900_at6082_hs224ef8e.aspx" UserDefinedDisableRowSelection="False" PageId="IN_68__CARGA_DE_ARQUIVOS_TEXTOS__REGISTRO106_GRID" Level="20" Order="1"  />
        </div>
