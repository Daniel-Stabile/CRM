...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:SimpleGrid runat="server" ID="GRID" Title="Encerrados" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_CP_REQUISICOES.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="((A.TIPO = 'F') AND A.STATUS = 4 AND (A.CONFIRMANTE = @USUARIO OR A.REQUISITANTE = @USUARIO))" FormUrl="~/aga/a/f/aga_t868_at3387_hs8411bd1.aspx" UserDefinedDisableRowSelection="False" PageId="REQUISICOESITENS_DE_FILIAL__ENCERRADOS_GRID" Level="20" Order="1"  />
        </div>
