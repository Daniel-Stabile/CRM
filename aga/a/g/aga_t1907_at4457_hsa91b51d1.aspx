...
(A.TIPOCONTRATO IN(SELECT X.HANDLE FROM CN_TIPOSCONTRATOS X WHERE X.HANDLE = A.TIPOCONTRATO AND X.TIPO = 3 AND X.EHCONTRATOCONVENIO = 'S' ))" FormUrl="~/aga/a/f/aga_t1907_at4457_hsa91b51d1.aspx" UserDefinedDisableRowSelection="False" PageId="CN_CONTRATOS_CONVENIOS__EMELABORACAO_GRID" Level="20" Order="1"  />
        </div>
