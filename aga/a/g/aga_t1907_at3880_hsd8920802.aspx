...
'S'))
 ...
 AND
(A.TIPOCONTRATO IN(SELECT X.HANDLE FROM CN_TIPOSCONTRATOS X WHERE X.HANDLE = A.TIPOCONTRATO AND X.TIPO = 2  AND X.EHCONTRATOCONVENIO = 'N' ))" FormUrl="~/aga/a/f/aga_t1907_at3880_hsd8920802.aspx" UserDefinedDisableRowSelection="False" PageId="CN_CONTRATOS_FATURAMENTO__CONTRATOS_CONFIRMA_ALTERA_GRID" Level="20" Order="1"  />
        </div>
