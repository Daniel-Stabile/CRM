<%@ Page Title="10.02 - PIS/COFINS dos Serviços (S)" Language="C#" Inherits="Benner.Tecnologia.Wes.Components.WebApp.WesPage" %>
...
SELECT IMPOSTO.HANDLE
 ...
 WHERE ITEM.HANDLE = IMPOSTO.ITEM
   ...
   AND NOTA.EMPRESA = @EMPRESA
   AND NOTA.TIPOREGISTRO=4
)" FormUrl="~/aga/a/f/aga_t3900_at6079_hs2fb8ef8e.aspx" UserDefinedDisableRowSelection="False" PageId="IN_68__CARGA_DE_ARQUIVOS_TEXTOS__REGISTRO102_GRID" Level="20" Order="1"  />
        </div>
