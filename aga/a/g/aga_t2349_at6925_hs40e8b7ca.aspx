...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:SimpleGrid runat="server" ID="GRID" Title="Baixados" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_MA_RECURSOPARTES.GRID" CanDelete="False" CanUpdate="True" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="LOCAL = 5 AND (A.PARTEPNEU = 1) AND (A.TIPOREGISTRO = 1)" FormUrl="~/aga/a/f/aga_t2349_at6925_hs40e8b7ca.aspx" UserDefinedDisableRowSelection="False" PageId="MF_CONJUNTOS_MECANICOS__BAIXADO_GRID" Level="20" Order="1"  />
        </div>
