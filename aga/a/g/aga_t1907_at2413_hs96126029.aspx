...
(A.TIPOCONTRATO IN(SELECT X.HANDLE FROM CN_TIPOSCONTRATOS X WHERE X.HANDLE = A.TIPOCONTRATO AND X.TIPO = 1  AND X.EHCONTRATOCONVENIO = 'N' ))" FormUrl="~/aga/a/f/aga_t1907_at2413_hs96126029.aspx" UserDefinedDisableRowSelection="False" PageId="CN_CONTRATOS__ENCERRADO_GRID" Level="20" Order="1"  />
        </div>
