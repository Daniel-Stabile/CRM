...
(A.TIPOCONTRATO IN(SELECT X.HANDLE FROM CN_TIPOSCONTRATOS X WHERE X.HANDLE = A.TIPOCONTRATO AND X.TIPO = 3 AND X.EHCONTRATOCONVENIO = 'S'  ))" FormUrl="~/aga/a/f/aga_t1907_at4463_hs2f370ca0.aspx" UserDefinedDisableRowSelection="False" PageId="CN_CONTRATOS_CONVENIOS__VENCIDOS_GRID" Level="20" Order="1"  />
        </div>
