...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:SimpleGrid runat="server" ID="GRID" Title="Cadastrados" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_CP_REQUISICOES.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="(A.TIPO = 'P' AND A.STATUS = 1 AND A.LIBERADA = 'N' AND (A.CONFIRMANTE = @USUARIO OR A.REQUISITANTE = @USUARIO))" FormUrl="~/aga/a/f/aga_t868_at5424_hs7783e420.aspx" UserDefinedDisableRowSelection="False" PageId="REQUISICOESITENS_DE_CONSUMO_DE_PRODUCAO__CADASTRADOS_GRID" Level="20" Order="1"  />
        </div>
