...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
 ...
 (A.LIBERADA = 'S' AND A.STATUS =1 AND A.EXPIMP = 'I') AND 
(
(A.GRUPOASSINATURAS IS NULL AND A.CONFIRMANTE = @USUARIO) 
OR 
...
'S'))
OR (A.GRUPOASSINATURAS IS NULL AND A.CONFIRMANTE IN (SELECT  D.USUARIO FROM CP_GRUPOALCADASUSUARIOS D, CP_GRUPOALCADASINTEGRANTES I, 

CP_GRUPOALCADAS G WHERE D.GRUPO = G.HANDLE AND I.GRUPO = G.HANDLE AND I.HANDLE = D.INTEGRANTE AND 

D.USUARIOAUTORIZADO = @USUARIO AND I.USUARIO = D.USUARIO AND D.ATIVO = 'S' AND I.ATIVO = 'S' AND I.AUSENTE = 

'S'))
)
)" FormUrl="~/aga/a/f/aga_t2943_at5271_hs396ca3c7.aspx" UserDefinedDisableRowSelection="False" PageId="IE_CARGA_PROFORMAS_IMP__CONFIRMAR_GRID" Level="20" Order="1"  />
        </div>
