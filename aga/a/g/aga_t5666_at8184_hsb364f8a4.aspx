...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:SimpleGrid runat="server" ID="GRID" Title="Encerrados" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" EntityViewName="AGA_LC_AQUISICAOREGISTROPRECO.GRID" CanDelete="False" CanUpdate="False" CanInsert="False" Mode="Selectable" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="CompanyAndBranch" UserDefinedCriteriaWhereClause="A.STATUS = 3 AND A.FILIAL = @FILIAL" FormUrl="~/aga/a/f/aga_t5666_at8184_hsb364f8a4.aspx" UserDefinedDisableRowSelection="False" PageId="LC_CARGA_DE_REGISTROPRECO__LC_CARGA_REGISTROPRECO_ENCERRADOS_GRID" Level="20" Order="1"  />
        </div>
