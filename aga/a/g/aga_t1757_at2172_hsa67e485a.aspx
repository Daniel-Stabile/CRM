...
AND ( (A.USUARIOINCLUIU = @USUARIO)  OR ( (SELECT FILTRAUSUARIOOVINCLUIU FROM Z_GRUPOUSUARIOS WHERE HANDLE= @USUARIO) = 'N'))" FormUrl="~/aga/a/f/aga_t1757_at2172_hsa67e485a.aspx" UserDefinedDisableRowSelection="False" PageId="CM_PASTAORDENSVENDA__CONFIRMADAS_GRID" Level="20" Order="1"  />
        </div>
