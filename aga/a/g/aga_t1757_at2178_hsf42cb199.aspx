...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
 ...
 (A.LIBERADOCONFIRMACAO = 'S' OR A.LIBERADOCONFIRMACAO IS NULL) AND (A.STATUS IN(1)) AND
(
...
'S'))
OR (A.GRUPOASSINATURAS IS NULL AND A.CONFIRMANTE = @USUARIO)
)
)" FormUrl="~/aga/a/f/aga_t1757_at2178_hsf42cb199.aspx" UserDefinedDisableRowSelection="False" PageId="CM_PASTAORDENSVENDA__CONFIRMAR_GRID" Level="20" Order="1"  />
        </div>
