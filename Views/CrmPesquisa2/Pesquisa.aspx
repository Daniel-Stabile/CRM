<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pesquisa.aspx.cs" Inherits="Views_CrmPesquisa2_Pesquisa" %>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title green">
                    <div class="caption ">
                        ...
                        <span class="caption-subject font-green bold uppercase">Questionario de Qualificação</span>
                    </div>
                </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-body col-md-12" style="margin-top:20px;">
                            <div class="alert alert-danger" v-if="Mensagem != 'Ok'">
                                <strong>Erro!</strong> Não existe questionario cadastrado para a Vertical da conta nessa filial !!!!
                            </div>
    ...
    var app = new Vue({
        ...
        methods: {
            SalvaQuestionario: function () {
                ...
                scope.Loading = true;
                $.ajax({
                    url: Benner.Page.getApplicationPath() +"api/crm/pesquisapost/save-questionario2",
            ...
            QualificaConta: function () {
                ...
                scope.Loading = true;
                $.ajax({
                    url: Benner.Page.getApplicationPath() +"api/crm/pesquisapost/qualifica-conta2",
                    //url: Benner.Page.getApplicationPath() + "CrmProdutoItens/SaveItens",
                    type: 'POST',
                    dataType: "json",
                    data:JSON.stringify(scope.Pesquisa),
