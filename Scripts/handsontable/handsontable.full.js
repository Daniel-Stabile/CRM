  ...
  (function (Handsontable) {
    ...
    var NumericRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
      if (Handsontable.helper.isNumeric(value)) {
        ...
        if (cellProperties.language == undefined || cellProperties.language == null)
          cellProperties.language = 'pt';
        
        if (cellProperties.format == undefined || cellProperties.format == null)
