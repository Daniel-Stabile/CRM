...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:AjaxForm runat="server" ID="INFORMAESDEPROCESSOSRELACIONADOSANORETENODETRIBUTOS" Title="Informações de processos relacionados a não retenção de tributos" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="REINF_R4020PROCESSOSEMRETENCAO.FORM" FormMode="View" IncludeRecordInRecentItems="True" UserDefinedCommandsVisible="True" PageId="REINF_REGISTRO_R4020_PROCESSOSEMRETENCAO" Level="20" Order="10"  />
        </div>
