<%@ Page Title="Aglutinador Documentos CPA" Language="C#" CodeFile="~/Erp/Financeiro/AglutinadorCPA/Geral.aspx.cs" Inherits="AglutinadorCPAGeralPage" %>
...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <div class="row">
        <wes:SimpleGrid runat="server" ID="DOCUMENTOS" Title="Contas a pagar" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="true" ProviderWidgetUniqueId="" ChromeState="Normal" CanDelete="False" CanUpdate="False" CanInsert="False" EntityViewName="FN_DOCUMENTOS.AGLUTINADORCPA.GRID" DefaultFilterName="Padrão aglutinador" Mode="FixedRequired" UserDefinedSelectColumnVisible="True" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="OnlyCompany" FormUrl="~/aga/a/materiais/recebimentoFisico/entregaItemOrdemCompra.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="ERP_FINANCEIRO_AGLUTINADORCPA_GERAL" Level="20" Order="10"  />
        </div>
