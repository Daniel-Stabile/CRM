...
function EventMouseOver(calEvent) {
    var tooltip = '<div class="fc-tooltipevent">' +
        '<div class="fc-tooltipevent-item">Horário:</div>' +
        '<div>' + calEvent.start.format("HH:mm") + ' - ' + calEvent.end.format("HH:mm") + '</div>' +
        '<div class="fc-tooltipevent-item">Turma:</div>' +
        '<div>' + calEvent.title + '</div>' +
        '<div class="fc-tooltipevent-item">Fornecedor:</div>' +
        '<div>' + calEvent.fornecedor + '</div>' +
        '<div class="fc-tooltipevent-item">Instrutor:</div>' +
        '<div>' + calEvent.instrutor + '</div>' +
        '<div class="fc-tooltipevent-item">Local do curso:</div>' +
        '<div>' + calEvent.local + '</div>' +
        '<div>' + calEvent.detalheslocal + '</div>' +
        '</div>';
    $("body").append(tooltip);
    $(this).mouseover(function (e) {
        $(this).css('z-index', 10000);
        $('.fc-tooltipevent').fadeIn('500');
        $('.fc-tooltipevent').fadeTo('10', 1.9);
    }).mousemove(function (e) {
        $('.fc-tooltipevent').css('top', e.pageY - 70);
        $('.fc-tooltipevent').css('left', e.pageX + 20);
    });
}
function EventMouseOut(calEvent) {
    $(this).css('z-index', 8);
    $('.fc-tooltipevent').remove();
}