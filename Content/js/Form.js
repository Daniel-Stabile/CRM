...
Form.changeStateGroup = function (section) {
    ...
    if (fontIcon.classList.contains("fa-angles-down")) {
        fontIcon.classList.remove("fa-angles-down")
        fontIcon.classList.add("fa-angles-up")

        groupSection.classList.add("minimized");

        cookie = idSection + "=closed; path=/";
    } else {
        fontIcon.classList.remove("fa-angles-up")
        fontIcon.classList.add("fa-angles-down")
