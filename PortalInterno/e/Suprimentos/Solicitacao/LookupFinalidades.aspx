<%@ Page Title="Pesquisar" Language="C#" Inherits="PortalInterno.Suprimentos.Solicitacoes.FinalidadeLookup, Benner.Corporativo.Wes.WebApp" %>
...
<body class="lookup-search bg-white allow-focus">
	<div class="col-md-12">
		<form id="formMain" runat="server">
			...
			<asp:HiddenField runat="server" ClientIDMode="Static" ID="sc" />
			<asp:HiddenField runat="server" ClientIDMode="Static" ID="dv" />
