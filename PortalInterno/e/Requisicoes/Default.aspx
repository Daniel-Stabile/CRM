<%@ Page Title="Requisições" Language="C#" AutoEventWireup="true"
    Inherits="PortalInterno.Requisicoes.DefaultPage, Benner.Corporativo.Wes.WebApp" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="Main">
    ...
    <div class="row">
        <erp:ErpFilterForm runat="server"
            ...
            EntityViewName="CP_WEBFILTROREQUISICOES.FORM"
            Title="Filtro"
    ...
    <div class="row">
        <erp:ErpSimpleGrid runat="server"
            ID="REQUISICOES_GRID"
            SystemInstanceName="CORPORATIVO"
            EntityViewName="PORTALINTERNO_CP_REQUISICOESPAI.GRID"
            Title="Requisições"
    ...
    <div class="row">
        <wes:SimpleGrid runat="server"
            ...
            SystemInstanceName="CORPORATIVO"
            EntityViewName="PORTALINTERNO_CP_REQUISICOES.GRID"
