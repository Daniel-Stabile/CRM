<%@ Page Language="C#" Title="Contratos de convênio" AutoEventWireup="true"
    Inherits="PortalInterno.Contratos.Convenio.DefaultPage, Benner.Corporativo.Wes.WebApp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <div class="row">
        ...
        <erp:ErpFilterForm runat="server"
            ...
            CanDelete="False"
            ShowTitle="False"
            UserDefinedCriteriaWhereClause="A.TIPO = 2"
            ChromeState="Normal"
            PageWidgetHandle="1" />    
    </div>
    ...
    <div class="row">
        <erp:ErpSimpleGrid runat="server"
            ID="CONTRATOS_GRID"
            SystemInstanceName="CORPORATIVO"
            EntityViewName="PORTALINTERNO_CONTRATOS_CONVENIO.GRID"
            Title="Contratos de convênio"
