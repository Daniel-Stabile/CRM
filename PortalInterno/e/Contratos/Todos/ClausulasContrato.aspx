                        ...
                        <erp:ErpTab runat="server" ID="tabDetalhes" Text="Detalhes">
                            <div class="row">                                
		                        <wes:AjaxForm 
                                    ...
                                    EntityViewName="PORTAL_INT_DETALHE_CLAUSULA_CONTRATO.FORM"
                        ...
                        <erp:ErpTab runat="server" ID="tabDocumentos" Text="Parágrafos">
                                ...
                                <div class="row">
                                    <wes:SimpleGrid runat="server"
                                        ...
                                        EntityViewName="PORTAL_INT_PARAGRAFOS_CLAUSULA.GRID"
                                ...
                                <div class="row">
		                            <wes:AjaxForm 
                                        ...
                                        ChromeState="Normal"
                                        HideDeveloperCommands="True"
                                        EntityViewName="PORTAL_INT_RESUMO_PARAGRAFO_CLAUSULA.FORM"
                                        PageWidgetHandle="110"  />
