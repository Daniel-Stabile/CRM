...
<asp:Content runat="server" ID="Content" ContentPlaceHolderID="Main">
    ...
    <script runat="server">
        ...
        protected override void OnPreRender(EventArgs e)
        {
             ...
             /*   DADOSFINANCEIROS_FORM.EnsureDataLoad();
                var entity = DADOSFINANCEIROS_FORM.GetEntity();
                if (entity["CONTAFINANCEIRA"].IsNull && entity["CENTROCUSTO"].IsNull && entity["PROJETO"].IsNull)
                    TAB_DADOSFINANCEIROS.TabVisible = false;*/
        ...
        <erp:ErpTab runat="server" ID="TAB_ESPECIFICACOES" Text="Especificações">
            <div class="row">
                <wes:AjaxForm runat="server"
                    ...
                    EntityViewName="PORTALINTERNO_REQAQUISICOESITENS_ESPECIFICACAO.FORM"
        ...
        <erp:ErpTab runat="server" ID="TAB_DADOSFINANCEIROS" Text="Dados Financeiros">
            <div class="row">
                ...
                <wes:AjaxForm runat="server"
                    ...
                    SystemInstanceName="CORPORATIVO"
                    EntityViewName="PORTALINTERNO_REQAQUISICOESITENS_DADOSFINANCEIROS.FORM"
                    IncludeRecordInRecentItems="False"
                    HideDeveloperCommands="False"
                    CanInsert="False"
                    CanUpdate="False"
