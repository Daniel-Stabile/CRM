            ...
            <asp:UpdatePanel ID="filterEditorUpdatePanel" runat="server" UpdateMode="Always">
                <ContentTemplate>
                    <div class="form-actions nobg no-border commands-bar fluid">
                        <asp:LinkButton ID="lnkBtnSave" OnClick="ButtonSave_Click" CssClass="btn blue command-action predef-action" runat="server"><i class="fa-duotone fa-check fa-fw btn-action"></i>Salvar</asp:LinkButton>
                        <asp:LinkButton ID="lnkBtnDelete" OnClick="ButtonDelete_Click" Enabled="false" CssClass="btn red command-action predef-action" runat="server"><i class="fa-duotone fa-trash-can fa-fw btn-action"></i>Excluir</asp:LinkButton>
                        <asp:LinkButton ID="lnkBtnCancel" OnClick="ButtonCancel_Click" CssClass="btn grey-silver command-action predef-action" runat="server"><i class="fa-duotone fa-xmark fa-fw btn-action"></i>Cancelar</asp:LinkButton>
                    </div>
