<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PerformancePreVendedor.ascx.cs" Inherits="Pages_K_CRM_PESSOAS_e_uc_PerformancePreVendedor" %>
    ...
    var gaugeChart = AmCharts.makeChart("chartdiv", {
        ...
        "axes": [{
            ...
            "bands": [{
                ...
                "radius": "40%",
                "innerRadius": "25%",
                "balloonText": json[3]["Prc"] + "%"
            }, {
                "color": "#67b7dc",
                "startValue": 0,
                "endValue": json[3]["Prc"] > 100 ? 100 : json[3]["Prc"],
                "radius": "40%",
                "innerRadius": "25%",
                "balloonText": json[3]["Prc"] + "%"
            }]
