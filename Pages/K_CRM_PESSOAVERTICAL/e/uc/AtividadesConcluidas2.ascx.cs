...
public partial class Pages_K_CRM_PESSOAVERTICAL_e_TimelineHistorico : UserControlBase<EntityBase>
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (entidadeBase != null)
        {
            ...
            query.CommandText.AppendLine(" WHERE A.PESSOA = :HANDLE AND A.VERTICAL = :VERTICAL  AND A.DATACONCLUSAO IS NOT NULL AND A.STATUS IN (2,3)");
            ...
            foreach (EntityBase result in resultSet)
            {
                ...
                if (item.email != "")
                {
                    if((roles.Contains("K_CRM_GESTOR_COMERCIAL")))
