                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:CheckBox Text="Contém dados LGPD" runat="server" ClientIDMode="Static" ID="ContainsLgpd" Checked="false" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">&nbsp;&nbsp;</label>
                                    <asp:CheckBox Text="Exibir na API" runat="server" ClientIDMode="Static" ID="ShowInApi" Checked="true"/>
                                </div>
                            </div>
                        </div>
