...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
            ...
            <div class="portlet light">
                <div class="tabbable-line">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#tabApis" data-toggle="tab">APIs</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tabApis">
                            <div class="row">
                                <wes:SimpleGrid runat="server" ID="GridTaskApis" EntityViewName="Z_TAREFAAPIS.GRID" ShowTitle="false" Title="Lista de Apis"
                                    UserDefinedCriteriaWhereClause="A.TAREFA = @CAMPO(HANDLE)" FormUrl="~/SiteSettings/TaskApis/Form.aspx" />
                            </div>
                        </div>
    ...
    <script runat="server">
        protected override void LoadWebPartConnections()
        {
            ...
            AddWebPartStaticConnection("FormTaskGridTaskApis", "FormTask", "GridTaskApis");
