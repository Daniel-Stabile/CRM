...
<%@ Register Src="~/uc/entityFieldsVisibility.ascx" TagName="EntityFieldsVisibility" TagPrefix="wesUserControl" %>
...
<div class="modal fade" id="listFields" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <wesUserControl:EntityFieldsVisibility ID="entityFieldsVisibilityControl" Title="Campos" EnableViewState="true" runat="server" />
        </div>
    </div>
</div>
