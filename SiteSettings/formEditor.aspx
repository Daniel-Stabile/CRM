            ...
            <div class="portlet light" style="margin-bottom:0;">
                ...
                <div class="portlet-body form">
                    <div id="editorCommandsBar" class="form-actions nobg no-border commands-bar fluid list-commands-bar">
                        ...
                        <a id="topBtnAddField" class="btn green custom-action" onclick="openScreenAddFields()" data-toggle="modal"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Campos</a>
                        <asp:LinkButton ID="topBtnAddPathField" CssClass="btn green custom-action" runat="server" OnClick="OnAddPathField" ClientIDMode="Static"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Traduzido</asp:LinkButton>
                        <asp:LinkButton ID="topBtnAddSqlField" CssClass="btn green custom-action" runat="server" OnClick="OnAddSQLField" ClientIDMode="Static"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Campo SQL</asp:LinkButton>
                        <asp:LinkButton ID="topBtnAddLabel" CssClass="btn green custom-action" runat="server" OnClick="OnAddLabelField" ClientIDMode="Static"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Customizado</asp:LinkButton>
                        <asp:LinkButton ID="topBtnAddSection" CssClass="btn green custom-action" runat="server" OnClick="OnAddSection" ClientIDMode="Static"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Seção</asp:LinkButton>
                        <asp:LinkButton ID="topBtnAddPage" CssClass="btn green custom-action" runat="server" OnClick="OnAddPage" ClientIDMode="Static"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Guia</asp:LinkButton>

                        <div id="editorAddCommandsGroup" class="btn-group command-action nested-menu" style="display:none;">
                            <a class="btn green dropdown-toggle hover-initialized" data-toggle="dropdown" data-hover="dropdown"><i class="fa-duotone fa-plus fa-fw btn-action"></i> Adicionar <i class="fa fa-angles-down"></i></a>
                        ...
                        <asp:LinkButton ID="btnDel" runat="server" CssClass="btn red predef-action" OnClick="OnButtonRemoveItemClick"><i class="fa-duotone fa-trash-can fa-fw"></i></asp:LinkButton>
