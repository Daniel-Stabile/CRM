            ...
            <div class="portlet light">
                    ...
                    <div class="actions">
                        <div class="btn-group">
                            <a href="http://wiki.benner.com.br/wiki/index.php?title=Categoria%3AVis%C3%B5es_-_WES" class="no-border btn btn-circle btn-default btn-sm" target="_blank">
                                <i class="fa-duotone fa-circle-question fa-fw"></i>
                            </a>
                        </div>
                ...
                <div class="portlet-body form">
                    <div class="form-actions nobg no-border commands-bar fluid">
                        <asp:LinkButton ID="lnkBtnSave" CssClass="btn blue command-action predef-action" runat="server"><i class="fa-duotone fa-check fa-fw btn-action"></i>Salvar</asp:LinkButton>
                        <asp:LinkButton ID="lnkBtnShowXml" CssClass="btn default command-action predef-action" runat="server" OnClick="OnShowXml"><i class="fa-duotone fa-code fa-fw btn-action"></i>XML</asp:LinkButton>

                        <div class="btn-group command-action custom-action hidden-lg" id="addGroup" style="display:inline-block;">
                            <a class="btn green dropdown-toggle hover-initialized" data-toggle="dropdown" data-hover="dropdown"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Adicionar <i class="fa-duotone fa-angles-down fa-fw"></i></a>
                        ...
                        <div class="predef-action hidden-md hidden-sm hidden-xs" style="display:inline-block;vertical-align:middle;">
                            <a id="btnAddFieldWide" class="btn green" onclick="openScreenAddFields()" data-toggle="modal"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Campos</a>
                            <asp:LinkButton ID="btnAddPathFieldWide" CssClass="btn green" runat="server" OnClick="OnAddPathField"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Traduzido</asp:LinkButton>
                            <asp:LinkButton ID="btnAddSqlFieldWide" CssClass="btn green" runat="server" OnClick="OnAddSQLField"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Campo SQL</asp:LinkButton>
                            <asp:LinkButton ID="btnAddLabelWide" CssClass="btn green" runat="server" OnClick="OnAddLabelField"><i class="fa-duotone fa-plus fa-fw btn-action"></i>Customizado</asp:LinkButton>
                        </div>

                        <div class="btn-group predef-action">
                            <asp:LinkButton ID="btnLeft" CssClass="btn btn-default" runat="server" OnClick="OnLeftClick"><i class="fa-duotone fa-arrow-left fa-fw"></i></asp:LinkButton>
                            <asp:LinkButton ID="btnRight" CssClass="btn btn-default" runat="server" OnClick="OnRightClick"><i class="fa-duotone fa-arrow-right fa-fw"></i></asp:LinkButton>
                        </div>

                        <asp:LinkButton ID="btnDel" runat="server" CssClass="btn red predef-action" OnClick="OnDeleteClick"><i class="fa-duotone fa-trash-can fa-fw"></i></asp:LinkButton>

                        <asp:LinkButton ID="togglePropertiesMenu" runat="server" CssClass="btn white predef-action pull-right" OnClientClick="toggleHiddenField('gridEditorPropertiesVisible')"><i class="fa-duotone fa-bars fa-fw"></i></asp:LinkButton>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
