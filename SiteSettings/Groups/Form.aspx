...
<%@ Register Assembly="Benner.Tecnologia.Wes.Components" Namespace="Benner.Tecnologia.Wes.Components" TagPrefix="wes" %>
    ...
    <wes:SimpleGrid runat="server" ID="FILTRODEREGITRO" Title="Filtro de registro" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="GRUPO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="Z_FILTROS.GRID" Mode="None" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="OnlyCompany" UserDefinedCriteriaWhereClause="A.GRUPO = @CAMPO(HANDLE) AND A.CATEGORIA = 2" FormUrl="~/SiteSettings/RecordsFilter/GroupForm.aspx" ShowExport="True" UserDefinedDisableRowSelection="False" PageId="GROUPFORM" Level="15" Order="150"  /></div>
        ...
        <div class="tab-pane" id="tabRESTRIESDEACESSO">
                    <div class="row">
    <wes:EditableGrid runat="server" ID="RESTRIESDEACESSO" Title="Restrições de acesso" Subtitle="" PortletCssClass="" PortletLayout="Default" BootstrapCols="12" FontIcon="" ShowTitle="false" ProviderWidgetUniqueId="GRUPO" ChromeState="Minimized" CanDelete="True" CanUpdate="True" CanInsert="True" EntityViewName="Z_ACESSORESTRICOES.GRID" Mode="Search" UserDefinedSelectColumnVisible="False" UserDefinedPageSize="10" SystemFilterOnly="False" DisplayRowCommand="True" CompanyFilterMode="OnlyCompany" UserDefinedCriteriaWhereClause="A.GRUPO = @CAMPO(HANDLE)" ShowExport="True" PageId="GROUPFORM" Level="15" Order="160"  /></div>
        </div>
      </div>
    </div>
  </div>
