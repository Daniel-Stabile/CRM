...
<form runat="server" id="formLogin" class="login-form form">
    ...
    <asp:Panel runat="server" ID="recoveryPassword">
        ...
        <asp:Panel runat="server" ID="recaptchaRecoveryPasswordPanel" CssClass="form-group">
            <wes:googleRecaptcha runat="server" id="googleRecaptchaRecoveryPassword" />            
        </asp:Panel>
        <div class="form-group">
    ...
    <asp:Panel runat="server" ID="simultaneousLogin">

        <asp:Panel runat="server" class="form-group">
            <label class="control-label visible-ie9">O usuário está logado em outro dispositivo.</label>
        </asp:Panel>

        <div class="form-group">
            <asp:LinkButton runat="server" ID="btSimultaneousLoginDeny" title="Voltar" CssClass="btn default"><i class='m-icon-swapleft'></i> Voltar</asp:LinkButton>
            <asp:LinkButton runat="server" ID="btSimultaneousLoginContinue" CssClass="btn blue pull-right" ClientIDMode="Static">Acessar <i class='m-icon-swapright m-icon-white'></i></asp:LinkButton>
		</div>
