...
<div class="portlet">
    ...
    <div class="portlet-body">
        ...
        <asp:Panel ID="divValidatePotentiallyDangerousScriptsInPdf" CssClass="form-group" runat="server">
            <asp:Label ID="Label25" CssClass="control-label" runat="server" Text="Validar conteúdo malicioso em PDFs"></asp:Label>
            <asp:CheckBox ID="chkValidatePotentiallyDangerousScriptsInPdf" CssClass="form-control" runat="server"></asp:CheckBox>
        </asp:Panel>
